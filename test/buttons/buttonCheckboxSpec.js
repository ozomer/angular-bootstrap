...
describe('wg-checkbox', function () {
  ...
  var templates = {
    'checkbox-default': {
      element: '<label class="btn"><input type="checkbox" ng-model="checkbox.value" wg-checkbox>Foo</label>'
    },
    'checkbox-custom-boolean-values': {
      element: '<label class="btn"><input type="checkbox" ng-model="checkbox.value" data-true-value="true" data-false-value="false" wg-checkbox>Foo</label>'
    },
    'checkbox-custom-integer-values': {
      element: '<label class="btn"><input type="checkbox" ng-model="checkbox.value" data-true-value="1" data-false-value="0" wg-checkbox>Foo</label>'
    },
    'checkbox-custom-string-values': {
      element: '<label class="btn"><input type="checkbox" ng-model="checkbox.value" data-true-value="yes" data-false-value="no" wg-checkbox>Foo</label>'
    },
    'checkbox-custom-interpolated-values': {
      scope: {trueValue: 'yes', falseValue: 'no'},
      element: '<label class="btn"><input type="checkbox" ng-model="checkbox.value" data-true-value="{{ trueValue }}" data-false-value="{{ falseValue }}" wg-checkbox>Foo</label>'
    },
    'checkbox-button-markup': {
      element: '<button class="btn" ng-model="checkbox.value" data-true-value="1" data-false-value="0" wg-checkbox>Foo</button>'
    },
    'checkbox-div-markup': {
      element: '<div class="btn" ng-model="checkbox.value" data-true-value="yes" data-false-value="no" wg-checkbox>Foo</button>'
    }
  };
