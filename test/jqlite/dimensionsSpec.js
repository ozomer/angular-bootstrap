...
describe('dimensions', function () {
  ...
  var $compile, $q, scope, dimensions;
  ...
  beforeEach(module('ngWidgets.bootstrap.jqlite.dimensions'));

  beforeEach(inject(function (_$rootScope_, _$compile_, _$q_, _dimensions_) {
    scope = _$rootScope_;
    $compile = _$compile_;
    $q = _$q_;
